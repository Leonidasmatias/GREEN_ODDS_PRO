...
export function SyncPanel() {
  ...
  const cards = [
    ...
    { label: "Ultima sincronizacao", value: status.lastSync ? new Date(status.lastSync).toLocaleString("pt-BR") : "Ainda nao executada", ok: status.lastStatus === "SUCCESS", icon: RefreshCw },
  ];
